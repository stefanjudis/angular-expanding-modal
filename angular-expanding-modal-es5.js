...
;(function (window, ng) {
  ...
  var ExpandingModal = function ExpandingModal($compile, $rootScope, $controller, $q, $http, $templateCache) {
    _classCallCheck(this, ExpandingModal);
  ...
  ng.module('sj.expandingModal', []).service('ExpandingModal', ['$compile', '$rootScope', '$controller', '$q', '$http', '$templateCache', ExpandingModal]);
